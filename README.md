...
* [.repo file for EL8](https://copr.fedorainfracloud.org/coprs/bnied/kernel-ml-aufs/repo/rhelbeta-8/bnied-kernel-ml-aufs-rhelbeta-8.repo)
...
Run the `build_ml_kernel.sh` script, and either answer all three questions, or provide them as command-line parameters:
...
or
    ...
    $ ./build_ml_kernel.sh -v=3.19 -a=x86_64 -e=7
