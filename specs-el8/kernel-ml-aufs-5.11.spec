...
# kernel-ml-aufs, devel, headers, perf, tools and bpftool.
%ifarch x86_64
%define with_doc 0
...
# Packages that need to be present before kernel-ml-aufs is installed
...
# and obsoletes for the kernel-ml-aufs package.
...
#
# This macro creates a kernel-ml-aufs-<subpackage>-devel package.
...
#
# This macro creates a kernel-ml-aufs-<subpackage>-modules-extra package.
...
#
# This macro creates a kernel-ml-aufs-<subpackage>-modules package.
...
#
# This macro creates a kernel-ml-aufs-<subpackage> meta package.
...
#
# This macro creates a kernel-ml-aufs-<subpackage>
...
# compression of the kernel-ml-aufs module files.
#
...
#
# Generate the kernel-ml-aufs-core and kernel-ml-aufs-modules file lists.
#
...
# Remove all the files that will be auto generated by depmod at the kernel-ml-aufs install time.
pushd $RPM_BUILD_ROOT/lib/modules/$KernelVer > /dev/null
%{__rm} -f modules.{alias*,builtin.bin,dep*,*map,symbols*,devname,softdep}
popd > /dev/null

# Go back and find all of the various directories in the tree.
# We use this for the directory lists in kernel-ml-aufs-core.
...
# Purge the kernel-ml-aufs-devel tree of leftover junk.
...
# Compute a content hash to export as Provides: kernel-ml-aufs-headers-checksum.
...
#
# This macro defines a %%post script for a kernel-ml-aufs package and its devel package.
...
#
# This macro defines a %%preun script for a kernel-ml-aufs package.
...
#
# This macro defines the %%files sections for the kernel-ml-aufs package
# and its corresponding devel package.
